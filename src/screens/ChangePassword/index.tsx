...
const ChangePassword = ({ navigation }: StackScreenProps<RootStackParamList, AuthenticatedScreens.ChangePassword>) => {
    ...
    return <ScrollView style={GlobalStyles.screenContainer} contentContainerStyle={styles.scrollContainer}>
        <Input title={t('profile.password.currentPassword')} required enabled secureText value={currentPassword} onChange={setCurrentPassword} />
        <Input title={t('profile.password.newPassword')} required enabled secureText value={newPassword} onChange={setNewPassword} />
        <Input title={t('profile.password.confirmPassword')} required enabled secureText value={confirmPassword} onChange={setConfirmPassword} />
        {errorMessage && (
            <View>
