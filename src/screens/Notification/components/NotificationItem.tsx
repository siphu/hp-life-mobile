...
export const NotificationItem = React.memo(({ item, onClick, onDelete }: { item: NotificationModel; onClick: (item: NotificationModel) => void; onDelete: (item: NotificationModel) => void; }) => {
    return (
        <View style={{
                    ...
                    <View
                        ...
                        {(item.imageUrl && (
                            ...
                            (item.type === 'CourseCertificateEarned' && (
                                <FastImage source={Images.pushNotification.certificate} style={styles.remoteImage} />
                            )) ||
                            (item.type === 'NewArticleAvailable' && (
                                <FastImage source={Images.pushNotification.news} style={styles.remoteImage} />
                            ))}
                    </View>
                </View>
