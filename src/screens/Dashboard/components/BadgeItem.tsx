...
export class BadgeItem extends React.PureComponent<{ item: MyBadge, onShare: () => void }> {
    render() {
        ...
        return (<View style={styles.badgeContainer}>
            <View style={styles.badgeRow}>
                ...
                <View style={styles.badgeRightContainer}>
                    ...
                    <Text numberOfLines={3} style={styles.badgeDescriptionText}>{item.description}</Text>
                    {isEarned && (
