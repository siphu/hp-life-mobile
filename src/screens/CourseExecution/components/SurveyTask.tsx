...
export const SurveyTask = connect(mapStateToProps)(({ taskDetail, orientation }: { taskDetail: TaskDetail, orientation: 'Portrait' | 'Landscape' }) => {
    const webViewRef = React.useRef<WebView>(null);

    return (<SafeAreaView edges={orientation === 'Landscape' ? ['left', 'right'] : ['bottom']} style={GlobalStyles.screenContainer}>
        <WebView
            ref={webViewRef}
