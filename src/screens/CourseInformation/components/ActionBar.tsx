...
export const ActionBar = ({ course, enrolled, navigation }: { course: Course | TraineeCourse; enrolled: boolean; navigation: StackNavigationProp<RootStackParamList, AuthenticatedScreens.CourseDetail, undefined> }) => {
    return (
            ...
            {course.status !== CourseStatus.Archived &&
                ...
                !(course as TraineeCourse).certificateId && (
                    <Button
                        ...
                        onPress={() => navigation.navigate(AuthenticatedScreens.CourseExecution, { courseId: course.id })}
                    />
                )}
