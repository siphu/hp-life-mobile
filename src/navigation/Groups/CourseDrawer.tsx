...
import CourseProvider, { useCourseProviderContext } from "~/providers/CourseProvider";
import { StackScreenProps } from "@react-navigation/stack";

const CourseDrawerNavigation = createDrawerNavigator<RootStackParamList>();

type CourseDrawerProps = StackScreenProps<RootStackParamList, AuthenticatedScreens.CourseDrawer>;
