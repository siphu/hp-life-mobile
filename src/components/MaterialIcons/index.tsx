...
export const MaterialIcons = createFontIcons(
  glyphMaps,
  'Material Icons',
  'MaterialIcons-Regular.ttf',
);
export const MaterialIconsOutlined = createFontIcons(
  glyphMapsOutlined,
  'Material Icons Outlined',
  'MaterialIconsOutlined-Regular.ttf',
);
export const MaterialSymbolsOutlined = createFontIcons(
  glyphMapsOutlined,
