    ...
    return (
        <View>
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'column', rowGap: 8 }}>
                        <Button variant="Primary"
                            ...
                            onPress={() => signOut().catch(() => { }).then(() => setShowLogout(false))}
                        />
            ...
            <TouchableOpacity style={styles.logoutContainer}
                onPress={() => setShowLogout(true)} accessibilityRole='button'>
                <MaterialIcons style={styles.linkIcon} name={'logout'}
                    size={24} color={config.color.neutral[900]} />
