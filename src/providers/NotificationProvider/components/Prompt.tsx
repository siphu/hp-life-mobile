...
export const Prompt = ({ visible, onClose, onConfirm }: { visible: boolean, onClose: () => void, onConfirm: () => void }) => {
    return (<Alert show={visible} position="Center" onRequestClose={onClose}>
        <View style={{
            rowGap: 20,
        }}>
            <View><Text style={{
            ...
            <View style={{ flexDirection: 'column', rowGap: 8 }}>
                <Button color={config.color.neutral[900]}
                    title={t('onboarding.pushNotification.button.yes')} onPress={onConfirm}
                />
